...
(function () {
    ...
    function changeQuestion(question){
        if(!question.hasClass('current-question')){
            ...
            icons.removeClass();
            questionLegend.removeClass('animate__animated');
            answer.removeClass('animate__animated');
            ...
            setTimeout(function(){
                questionLegend.addClass('animate__animated');
                icons.each(function(){
                    var $this = $(this);
                    if($this.data('animate') == 'left'){
                        setTimeout(function(){
                            $this.addClass('animate__bounceInLeft animate__animated');
                        }, animationDelay);
                    } else if($this.data('animate') == 'right') {
                        setTimeout(function(){
                            $this.addClass('animate__bounceInRight animate__animated');
                        }, animationDelay);
                    } else {
                        setTimeout(function(){
                            $this.addClass('animate__bounceIn animate__animated');
                        }, animationDelay);
                    }
                    animationDelay+=500;
                });
                ...
                setTimeout(function(){
                    answer.addClass('animate__animated');
                }, animationDelay);
            }, 200);
    ...
    function resetQuiz(){
        ...
        quizPanel.find('.animate__animated').removeClass('animate__animated');
    ...
    function setResults(score){ // this function displays the results
        var resultLink;
        var resultTitle;
        var arr = ['12111', '11211', '11121', '12211', '12221', '12222', '11221', '11222', '12112', '22221', '11111', '11122', '11212', '21111', '22111', '22211', '21221', '21211', '21121', '22121', '11112', '12122', '22222', '21222', '21122', '21112', '21212', '22212', '22112'];
